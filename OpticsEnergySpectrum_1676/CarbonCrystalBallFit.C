...
void CarbonCrystalBallFit(std::string HRSArm="L"){
	...
	CarbonSpectrumF->SetParameters(548.471,-0.03782,0.0038446,0.677518,2.33266,38.483,-0.0804,0.01,0.765,0.63);
...
//	CarbonSpectrumF->SetLineColor(2);
//	CarbonSpectrumF->SetLineWidth(3);
//	CarbonSpectrumF->SetParameters(3474, -0.01222, 1.466e-4, 1.64, 1.1615);
