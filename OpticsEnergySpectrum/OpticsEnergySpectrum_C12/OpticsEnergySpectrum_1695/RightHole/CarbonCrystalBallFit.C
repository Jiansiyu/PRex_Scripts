...
void CarbonCrystalBallFit(std::string HRSArm="L"){
	...
	t->Add("/home/newdriver/PRex/PRex_Data/PRex_Data/rootfile/Dp/prexLHRS_1695_-1_0_optics_check.root");
	t->Add("/home/newdriver/PRex/PRex_Data/PRex_Data/rootfile/Dp/prexLHRS_1695_-1_0_optics_check_1.root");
	t->Add("/home/newdriver/PRex/PRex_Data/PRex_Data/rootfile/Dp/prexLHRS_1695_-1_0_optics_check_2.root");
	t->Add("/home/newdriver/PRex/PRex_Data/PRex_Data/rootfile/Dp/prexLHRS_1695_-1_0_optics_check_3.root");
...
//	// select the righ bottom hole
	std::string fiducials = Form("(%s.gold.th)<-0.02 &&(%s.gold.th)>-0.033 && (%s.gold.ph)<0.0075 && (%s.gold.ph)>0.0035",
				HRSArm.c_str(),HRSArm.c_str(),HRSArm.c_str(),HRSArm.c_str());
	...
	TF1 *fCtrxGaus=new TF1("fCtrxGaus","gaus",0.0102,0.118);
	...
	TH1F *golddPhist = new TH1F("gold.dp", "gold.dp", 1000, 0.0, 0.01); //1676
    ...
    TF1 *fCgoldDpGaus=new TF1("fCgoldDpGaus","gaus",0.006,0.0076);
    ...
    TF1 *fCgoldDpCrystal=new TF1("fCgoldDpCrystal","crystalball",0.0,fCgoldDpGaus->GetXmax());  // get the gaus fit for each individual peak, and use the paramater for the crystal ball
