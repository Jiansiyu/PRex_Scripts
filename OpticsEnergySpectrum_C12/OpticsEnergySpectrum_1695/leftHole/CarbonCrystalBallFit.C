...
//				HRSArm.c_str(),HRSArm.c_str(),HRSArm.c_str(),HRSArm.c_str());
	...
	std::string fiducials = Form("(%s.gold.th)<0.022 &&(%s.gold.th)>0.014 && (%s.gold.ph)<-0.007 && (%s.gold.ph)>-0.010",
				HRSArm.c_str(),HRSArm.c_str(),HRSArm.c_str(),HRSArm.c_str());
...
//				HRSArm.c_str(),HRSArm.c_str(),HRSArm.c_str(),HRSArm.c_str());
	...
	TF1 *fCtrxGaus=new TF1("fCtrxGaus","gaus",0.010,0.128);
    ...
    TF1 *fCgoldDpGaus=new TF1("fCgoldDpGaus","gaus",0.006,0.0072);
